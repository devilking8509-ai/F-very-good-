...
XP: {fix_num(data['xp'])}\n\n
°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°
[FFB300][b][c]MADE BY Raihan.08 YT
            """
            return msg
        else:
            msg = """
...
[b][i][FFC0CB]youtube: Raihan.08gamer[/b]

[b][c][FFC0CB]subcribe: my_channel[FFFFFF]
 
[b][i][FFA500]telegram: @raihanpaid[/b]

[b][c][FFA500]telegram contact: @raihanpaid[A52A2A]
 
Enjoy the bot my friend.......

[C][B][0000FF] Created by Raihan 
Modified by - RIH
"""
                        ...
                        if inPuTMsG.strip().lower() in ("op", "/raihan", "hi", "/help"):
...
[B][C][FFFFFF]/join code [00FF00]- Join
[B][C][FFFFFF]/exit [00FF00]- Leave
[B][C][FFFFFF]/s [00FF00]- Start
[B][C][FFFFFF]/r code uid emoteid [00FF00]- No Detect 
...
[C][B][FFB300]👑 Owner: Raihan.08 gamer
[00FFFF]━━━━━━━━━━━━'''
...
[FFFFFF]🤖 Bot Name: [00FF00]{LoGinDaTaUncRypTinG.AccountName if hasattr(LoGinDaTaUncRypTinG, 'AccountName') else 'Raihan Bot'}
...
[C][B][FFB300]👑 Developed by: Raihan.08 YT
[00FF00]━━━━━━━━━━━━"""
...
async def MaiiiinE():
    ...
    Uid , Pw = '4305911449','E02E1426DB672AF77AF0711890BC0EA9B6B2B3FDDE261C73ABBDECD73C0BD0F1'
